...
const Investments = () => {
  ...
  return (
    <section
      id="investments"
      ref={sectionRef}
      className="w-full h-auto xl:min-h-screen flex flex-col justify-center bg-primary z-20 gap-12 py-32 px-8 items-center relative"
    >
      <div className="absolute inset-0 -z-10 opacity-80 bg-black"></div>
      <AnimatedBackground />

      {/* Cabecera */}
      <div className="flex flex-col w-full gap-4 justify-start items-start  2xl:relative 2xl:inset-auto 2xl:px-0">
